...
async function main() {
    ...
    // 3. Creating 5 workspaces and adding members (Workspace & WorkspaceMember)
    const workspaces = [];
    for (let i = 1; i <= 5; i++) {
    ...
    // 4. Creating 5 projects (Project & ProjectMember)
    const projects = [];
    for (let i = 1; i <= 5; i++) {
    ...
    // 5. Creating 10 tasks (Task table)
    const tasks = [];
    for (let i = 1; i <= 10; i++) {
    ...
    // 6. Creating 5 comments (Comment table)
    for (let i = 1; i <= 5; i++) {
    ...
    // 7. Creating 5 logs (ActivityLog table)
    for (let i = 1; i <= 5; i++) {
